    ...
    foreach ($results as $blogpost) {
        if($_SESSION['user']['user_type']) {
            echo '<div class="post">
                        ...
                        <a class="post" href="/individuella-php/php/post.php?id='. $blogpost->id .'">'.$blogpost->title. '</a>
            
                 </div>';
                 echo '<button class="btn">
                   
                 <a class="btn" href="/individuella-php/php/deletepost.php?id='. $blogpost->id .'">Delete</a>
     
                 </button>';
                 
        } else {     
                    echo '<div class="post"><a class="post" href="/individuella-php/php/post.php?id='. $blogpost->id .'">'.$blogpost->title. '</a></div>';
                }     
    }
